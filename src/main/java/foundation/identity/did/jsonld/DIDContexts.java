    ...
    static {
        ...
        try {
            ...
            CONTEXTS.put(JSONLD_CONTEXT_W3_NS_DID_V1,
                    JsonDocument.of(MediaType.JSON_LD, DIDContexts.class.getResourceAsStream("w3-ns-did-v1.jsonld")));
            CONTEXTS.put(JSONLD_CONTEXT_W3_2019_DID_V1,
                    JsonDocument.of(MediaType.JSON_LD, DIDContexts.class.getResourceAsStream("w3-2019-did-v1.jsonld")));
            CONTEXTS.put(JSONLD_CONTEXT_W3ID_DID_V1,
                    JsonDocument.of(MediaType.JSON_LD, DIDContexts.class.getResourceAsStream("w3id-did-v1.jsonld")));
            CONTEXTS.put(JSONLD_CONTEXT_W3ID_DID_V011,
                    JsonDocument.of(MediaType.JSON_LD, DIDContexts.class.getResourceAsStream("w3id-did-v011.jsonld")));
            CONTEXTS.put(JSONLD_CONTEXT_W3ID_SECURITY_V1,
                    JsonDocument.of(MediaType.JSON_LD, DIDContexts.class.getResourceAsStream("security-v1.jsonld")));
            CONTEXTS.put(JSONLD_CONTEXT_W3ID_SECURITY_V2,
                    JsonDocument.of(MediaType.JSON_LD, DIDContexts.class.getResourceAsStream("security-v2.jsonld")));
            CONTEXTS.put(JSONLD_CONTEXT_W3ID_SECURITY_V3,
                    JsonDocument.of(MediaType.JSON_LD, DIDContexts.class.getResourceAsStream("security-v3-unstable.jsonld")));
            CONTEXTS.put(JSONLD_CONTEXT_W3ID_VERESONE_V1,
                    JsonDocument.of(MediaType.JSON_LD, DIDContexts.class.getResourceAsStream("w3id-veresone-v1.jsonld")));
